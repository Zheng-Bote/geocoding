/**
 * SPDX-FileComment: Header file for the Marea Tides API adapter.
 * SPDX-FileType: SOURCE
 * SPDX-FileContributor: ZHENG Robert
 * SPDX-FileCopyrightText: 2026 ZHENG Robert
 * SPDX-License-Identifier: MIT
 *
 * @file adapter_marea_tides.hpp
 * @brief Adapter for the Marea Tides API.
 * @version 0.1.0
 * @date 2026-02-14
 *
 * @author ZHENG Robert
...
/**
 * @brief Adapter implementation for the Marea Tides API.
 */
class MareaTidesAdapter : public ApiAdapter {
public:
  /**
   * @brief Gets the name of the API adapter.
   * @return std::string "marea_tides".
   */
  std::string name() const override { return "marea_tides"; }

  /**
   * @brief Parses the JSON response from the Marea Tides API.
